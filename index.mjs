import { createThemeContract, createTheme, style, globalFontFace, globalStyle } from '@vanilla-extract/css';
import { structuredTokens } from 'hpe-design-tokens';
import { recipe } from '@vanilla-extract/recipes';

const vars = createThemeContract(structuredTokens);
const theme = createTheme(vars, structuredTokens);
...
const grommet = style([theme, font]);
...
export { anchor, box, button, contentSizeVariants, gapVariants, grid, grommet, heading, icon, marginVariants, padVariants, page, pageContent, text, textInput, theme, vars };
